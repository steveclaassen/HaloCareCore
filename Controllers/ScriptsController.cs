...
namespace HaloCareCore.Controllers
{
    public class ScriptsController : Controller
    {
        ...
        public ScriptsController(OH17Context context, IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
        ...
        //            xsl.Load(Path.Combine(webRootPath, "../../xml/AuthoriseScript.xslt"));
        ...
        public ActionResult ExportOutstandingScriptsToExcel()
        {
            ...
            {
                var worksheet = workbook.Worksheets.Add("OutstandingScripts");
                var currentRow = 1;
                for (int i = 0; i < model.Count; i++)
                {
                    ...
                    worksheet.Cell(currentRow, 14).Value = model[i].dependantID;
                    worksheet.Cell(currentRow, 15).Value = model[i].overdue;
                    worksheet.Cell(currentRow, 16).Value = model[i].monthsOutstanding;
                    currentRow++;
                }
